...
public class ParallelFileTreeWalkerTest extends spock.lang.Specification {
	...
	def "files processed before directories"() {
		...
		FileSystem.createDirectoryIn(path1Root, directory1Path)
		FileSystem.createFileIn(path1Root, file1Path)
		FileSystem.createDirectoryIn(path1Root, directory2Path)
		FileSystem.createDirectoryIn(path1Root, directory3Path)
	...
	def "sub directory both paths"() {
		...
		FileSystem.createDirectoryIn(path1Root, directoryPath)
		FileSystem.createDirectoryIn(path2Root, directoryPath)
	...
	def "nested sub directories path 1 only"() {
		...
		FileSystem.createDirectoryIn(path1Root, level1Path)
		FileSystem.createDirectoryIn(path1Root, level2Path)
		FileSystem.createDirectoryIn(path1Root, level3Path)
		FileSystem.createDirectoryIn(path1Root, level4Path)
	...
	def "nested sub directories path 2 only"() {
		...
		def final level3Path = level2Path.resolve("subDirectory3")
		def final level4Path = level3Path.resolve("subDirectory4")
		FileSystem.createDirectoryIn(path2Root, level1Path)
		FileSystem.createDirectoryIn(path2Root, level2Path)
		FileSystem.createDirectoryIn(path2Root, level3Path)
		FileSystem.createDirectoryIn(path2Root, level4Path)
	...
	def "various files and directories"() {
		...
		FileSystem.createFileIn(path1Root, file2Path)
		FileSystem.createDirectoryIn(path1Root, directory2Path)
		FileSystem.createDirectoryIn(path1Root, directory21Path)
		FileSystem.createFileIn(path1Root, file211Path)
		FileSystem.createFileIn(path1Root, file212Path)
		FileSystem.createDirectoryIn(path1Root, directory22Path)
		...
		FileSystem.createDirectoryIn(path1Root, directory221Path)
		...
		FileSystem.createDirectoryIn(path1Root, directory222Path)
		...
		FileSystem.createDirectoryIn(path1Root, directory223Path)
		...
		FileSystem.createDirectoryIn(path1Root, directory23Path)
		...
		FileSystem.createFileIn(path2Root, file1Path)
		FileSystem.createFileIn(path2Root, file3Path)
		FileSystem.createDirectoryIn(path2Root, directory1Path)
		...
		FileSystem.createDirectoryIn(path2Root, directory11Path)
		...
		FileSystem.createDirectoryIn(path2Root, directory12Path)
		...
		FileSystem.createDirectoryIn(path2Root, directory13Path)
		...
		FileSystem.createDirectoryIn(path2Root, directory2Path)
		...
		FileSystem.createDirectoryIn(path2Root, directory21Path)
		FileSystem.createFileIn(path2Root, file211Path)
		FileSystem.createFileIn(path2Root, file213Path)
		FileSystem.createDirectoryIn(path2Root, directory3Path)
