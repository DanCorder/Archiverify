...
public class ParallelFileTreeWalkerTest extends spock.lang.Specification {
	...
	def "single file in both roots"() {
		...
		FileSystem.createFileIn(path1Root, filePath)
		FileSystem.createFileIn(path2Root, filePath)
	...
	def "two files in both roots"() {
		...
		FileSystem.createFileIn(path1Root, file1Path)
		FileSystem.createFileIn(path1Root, file2Path)
		FileSystem.createFileIn(path2Root, file1Path)
		FileSystem.createFileIn(path2Root, file2Path)
	...
	def "various files in both roots"() {
		...
		FileSystem.createFileIn(path2Root, file1Path)
		FileSystem.createFileIn(path1Root, file2Path)
		FileSystem.createFileIn(path1Root, file3Path)
		FileSystem.createFileIn(path2Root, file3Path)
		FileSystem.createFileIn(path2Root, file4Path)
	...
	def "files processed before directories"() {
		...
		FileSystem.createSubDirectoryIn(path1Root, directory1Path)
		FileSystem.createFileIn(path1Root, file1Path)
		FileSystem.createSubDirectoryIn(path1Root, directory2Path)
		FileSystem.createSubDirectoryIn(path1Root, directory3Path)
	...
	def "sub directory both paths"() {
		...
		FileSystem.createSubDirectoryIn(path1Root, directoryPath)
		FileSystem.createSubDirectoryIn(path2Root, directoryPath)
	...
	def "nested sub directories path 1 only"() {
		...
		FileSystem.createSubDirectoryIn(path1Root, level1Path)
		FileSystem.createSubDirectoryIn(path1Root, level2Path)
		FileSystem.createSubDirectoryIn(path1Root, level3Path)
		FileSystem.createSubDirectoryIn(path1Root, level4Path)
	...
	def "nested sub directories path 2 only"() {
		...
		def final level3Path = level2Path.resolve("subDirectory3")
		def final level4Path = level3Path.resolve("subDirectory4")
		FileSystem.createSubDirectoryIn(path2Root, level1Path)
		FileSystem.createSubDirectoryIn(path2Root, level2Path)
		FileSystem.createSubDirectoryIn(path2Root, level3Path)
		FileSystem.createSubDirectoryIn(path2Root, level4Path)
	...
	def "various files and directories"() {
		...
		FileSystem.createFileIn(path1Root, file2Path)
		FileSystem.createSubDirectoryIn(path1Root, directory2Path)
		FileSystem.createSubDirectoryIn(path1Root, directory21Path)
		FileSystem.createFileIn(path1Root, file211Path)
		FileSystem.createFileIn(path1Root, file212Path)
		FileSystem.createSubDirectoryIn(path1Root, directory22Path)
		FileSystem.createFileIn(path1Root, file221Path)
		FileSystem.createFileIn(path1Root, file222Path)
		FileSystem.createFileIn(path1Root, file223Path)
		FileSystem.createSubDirectoryIn(path1Root, directory221Path)
		FileSystem.createFileIn(path1Root, file2211Path)
		FileSystem.createFileIn(path1Root, file2212Path)
		FileSystem.createFileIn(path1Root, file2213Path)
		FileSystem.createSubDirectoryIn(path1Root, directory222Path)
		FileSystem.createFileIn(path1Root, file2221Path)
		FileSystem.createFileIn(path1Root, file2222Path)
		FileSystem.createFileIn(path1Root, file2223Path)
		FileSystem.createSubDirectoryIn(path1Root, directory223Path)
		FileSystem.createFileIn(path1Root, file2231Path)
		FileSystem.createFileIn(path1Root, file2232Path)
		FileSystem.createFileIn(path1Root, file2233Path)
		FileSystem.createSubDirectoryIn(path1Root, directory23Path)
		FileSystem.createFileIn(path1Root, file231Path)
		FileSystem.createFileIn(path1Root, file232Path)
		FileSystem.createFileIn(path1Root, file233Path)
		FileSystem.createSubDirectoryIn(path1Root, directory3Path)
		FileSystem.createFileIn(path1Root, file31Path)
		FileSystem.createFileIn(path1Root, file32Path)
		FileSystem.createFileIn(path1Root, file33Path)

		FileSystem.createFileIn(path2Root, file1Path)
		FileSystem.createFileIn(path2Root, file3Path)
		FileSystem.createSubDirectoryIn(path2Root, directory1Path)
		FileSystem.createFileIn(path2Root, file11Path)
		FileSystem.createFileIn(path2Root, file12Path)
		FileSystem.createFileIn(path2Root, file13Path)
		FileSystem.createSubDirectoryIn(path2Root, directory11Path)
		FileSystem.createFileIn(path2Root, file111Path)
		FileSystem.createFileIn(path2Root, file112Path)
		FileSystem.createFileIn(path2Root, file113Path)
		FileSystem.createSubDirectoryIn(path2Root, directory12Path)
		FileSystem.createFileIn(path2Root, file121Path)
		FileSystem.createFileIn(path2Root, file122Path)
		FileSystem.createFileIn(path2Root, file123Path)
		FileSystem.createSubDirectoryIn(path2Root, directory13Path)
		FileSystem.createFileIn(path2Root, file131Path)
		FileSystem.createFileIn(path2Root, file132Path)
		FileSystem.createFileIn(path2Root, file133Path)
		FileSystem.createSubDirectoryIn(path2Root, directory2Path)
		FileSystem.createFileIn(path2Root, file21Path)
		FileSystem.createFileIn(path2Root, file22Path)
		FileSystem.createFileIn(path2Root, file23Path)
		FileSystem.createSubDirectoryIn(path2Root, directory21Path)
		FileSystem.createFileIn(path2Root, file211Path)
		FileSystem.createFileIn(path2Root, file213Path)
		FileSystem.createSubDirectoryIn(path2Root, directory3Path)
		FileSystem.createFileIn(path2Root, file31Path)
		FileSystem.createFileIn(path2Root, file32Path)
		FileSystem.createFileIn(path2Root, file33Path)
